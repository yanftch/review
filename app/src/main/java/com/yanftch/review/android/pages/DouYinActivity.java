...
//                            LogUtil.e("debug_DetailPlayEvaluationActivity:", "onScrollStateChanged==> " + "viewByPosition = "  + viewByPosition);
    ...
    protected void onDestroy() {
        if (null != mRvEvaluation) {
            try {
                RecyclerView.ViewHolder viewHolderForAdapterPosition = mRvEvaluation.findViewHolderForAdapterPosition(mCurrentPosition);
                if (viewHolderForAdapterPosition != null) {
                    DetailPlayEvaluationAdapter.ItemViewHolder holder = (DetailPlayEvaluationAdapter.ItemViewHolder) viewHolderForAdapterPosition;

                }
            } catch (Exception e) {
                e.printStackTrace();
            }
//            View view = mRvEvaluation.getChildAt(mCurrentPosition);
//            if (null != view && null != mRvEvaluation.getChildViewHolder(view)) {
//                DetailPlayEvaluationAdapter.ItemViewHolder holder = (DetailPlayEvaluationAdapter.ItemViewHolder) mRvEvaluation.getChildViewHolder(view);
//                LogUtil.e("debug_DetailPlayEvaluationActivity:", "onDestroy==> " + "holder.hashCode = " + handler.hashCode() + ",  "  + holder.mZvvVideo);
//                if (holder != null && holder.mZvvVideo != null && holder.mZvvVideo.getVideoView() != null) {
//                    holder.mZvvVideo.pause();
//                }
//            }
        }
        super.onDestroy();

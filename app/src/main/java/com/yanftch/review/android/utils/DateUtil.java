...
public class DateUtil {
    ...
    public static String changeFormatDate(String startDate, String oldFormat, String newFormat) {
        String newStr = "";
        SimpleDateFormat old_sdf = new SimpleDateFormat(oldFormat);
        SimpleDateFormat new_sdf = new SimpleDateFormat(newFormat);
        try {
            Date date = old_sdf.parse(startDate);
            newStr = new_sdf.format(date);
        } catch (ParseException e) {
            e.printStackTrace();
        }
        return newStr;
    ...
    public static Date changeFormatToDate(String startDate, String format, String format2) {
        String str2 = "";
        Date toDate = null;
        SimpleDateFormat sdf = new SimpleDateFormat(format);
    ...
    public static long getTimeLength(String begin, String end) {
        long time1 = TimeS2L(begin, TIME_FORMAT);
        long time2 = TimeS2L(end, TIME_FORMAT);
        return time2 - time1;
    }

    public static long getTimeLength(String begin, String end, String format) {
        long time1 = TimeS2L(begin, format);
        long time2 = TimeS2L(end, format);
        return time2 - time1;
    }
...
//        String strDay = day < 10 ? "0" + day : "" + day; // 天
    ...
    public static Calendar strToCalendar(String dstr, String format) {
        Calendar calendar = Calendar.getInstance();
        if (TextUtils.isEmpty(dstr))
            return calendar;
        Date date = null;
    ...
    public static Calendar dateToCalendar(Date date, String format) {
        Calendar calendar = Calendar.getInstance();
        if (date == null)
            return calendar;
        try {
